...
def main() -> int:
    ...
    # --------------------------------------------------------- 6. power cycle
    step(6, "Turn the printer off and then on again")
    ...
    print()
    print("  Then watch the WiFi icon on the printer's own screen and wait for")
    print("  it to become SOLID. That can take up to 30 seconds.")
    print()
